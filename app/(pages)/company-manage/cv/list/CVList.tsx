...
export const CVList = () => {
  ...
  return (
    ...
    <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-[20px]">
      {listCV.map((item) => {
          const workingForm =  workingFormList.find(job =>job.value == item.jobWorkingForm)?.label
        ...
        >
          ...
          <div className={"mt-[6px] flex justify-center items-center gap-[8px] font-[400] text-[14px]" + (item.viewed ? "" : "text-[#FF0000]")}>
