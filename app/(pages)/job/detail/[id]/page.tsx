            ...
            <div className="flex flex-wrap gap-[20px]">
              ...
              <div className="lg:w-[65%] w-[100%]">
                ...
                <div className="border border-[#DEDEDE] rounded-[8px] p-[20px]">
                  ...
                  <Link href="#formApllay" className="bg-[#0088FF] rounded-[4px] font-[700] text-[16px] text-white flex items-center justify-center h-[48px] mb-[20px]">
                    Ứng tuyển
                  </Link>
                  ...
                  <div className="flex flex-wrap gap-[8px]">
                    {jobDetail.technologies.map((itemTech: string, index: number) => (
                    <div key={index} className="border border-[#DEDEDE] rounded-[20px] font-[400] text-[12px] text-[#414042] py-[6px] px-[16px]">
                      {itemTech}
                    </div>
                    ))}
                  </div>
                ...
                {/* Form ứng tuyển */}
                <div id="formApllay" className="border border-[#DEDEDE] rounded-[8px] p-[20px] mt-[20px]">
